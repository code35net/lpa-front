...
const ListToolbar = () => {
  ...
  return (
    <div className='d-flex justify-content-end' data-kt-item-table-toolbar='base'>
      ...
      {/* begin::Add Places */}
      { currentUser?.roleName == "Key Account" && (<Link className='btn btn-sm btn-dark btn-active-light-dark me-3' to={`../OpPlanner`}>{intl.formatMessage({id: 'AUDITS.LIST.ADD_OP'})}</Link>) }
