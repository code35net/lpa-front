...
const Columns: ReadonlyArray<Column<Model>> = [
  ...
  },
  {
    Header: (props) => (
      <CustomHeader
        tableProps={props}
        title={useIntl().formatMessage({id: 'AUDIT_CHANGE_TEXT'})}
        className='min-w-125px'
      />
    ),
    id: 'text',
  ...
  },
  {
    Header: (props) => (
      <CustomHeader
        tableProps={props}
        title={useIntl().formatMessage({id: 'AUDIT_CHANGE_AUDIT'})}
        className='min-w-125px'
      />
    ),
    id: 'auditId',
...

  {
    Header: (props) => (
      <CustomHeader
        tableProps={props}
        title={useIntl().formatMessage({id: 'AUDIT_CHANGE_UNIT_OLD'})}
        className='min-w-125px'
      />
    ),
    id: 'oldunitId',
...

  {
    Header: (props) => (
      <CustomHeader
        tableProps={props}
        title={useIntl().formatMessage({id: 'AUDIT_CHANGE_UNIT'})}
        className='min-w-125px'
      />
    ),
    id: 'unitId',
