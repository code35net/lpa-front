...
const Columns: ReadonlyArray<Column<Model>> = [
  ...
  {
    Header: (props) => <CustomHeader tableProps={props} title={useIntl().formatMessage({id: 'ANSWERTEMPLATES.NAME'})} className='min-w-125px' />,
    id: 'text',
    Cell: ({...props}) => <InfoCell item={props.data[props.row.index].text} />,
  },
  {
    Header: (props) => <CustomHeader tableProps={props} title={useIntl().formatMessage({id: 'ANSWERTEMPLATES.OPTIONS'})} className='min-w-125px' />,
    id: 'Options',
    Cell: ({...props}) => <InfoCell item={props.data[props.row.index].options} />,
  },
