...
const ActionsCell: FC<Props> = ({id}) => {
  ...
  const openUserModal = () => {
    if(setItemIdForUpdate2 != undefined)
    {
      setItemIdForUpdate2(id)
    }
  }
  ...
  return (
    ...
    <div className='d-flex justify-content-end flex-shrink-0'>
        ...
        <a
          className='btn btn-icon btn-warning btn-active-warning btn-sm me-1'
          onClick={openUserModal}
        >
          <KTSVG path='/media/icons/duotune/general/gen011.svg' className='svg-icon-3' />
        </a>
