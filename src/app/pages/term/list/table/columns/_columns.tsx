...
const Columns: ReadonlyArray<Column<Model>> = [
  ...
  },
  {
    ...
    id: 'name',
    Cell: ({...props}) => <InfoCell item={props.data[props.row.index].termName} />,
  },
  {
    Header: (props) => <CustomHeader tableProps={props} title={useIntl().formatMessage({id: 'TERM.STARTDAY'})}  className='min-w-125px' />,
    id: 'startDay',
    Cell: ({...props}) => <DateCell item={props.data[props.row.index].startDay} />,
  },
  {
    Header: (props) => <CustomHeader tableProps={props} title={useIntl().formatMessage({id: 'TERM.ENDDAY'})}  className='min-w-125px' />,
    id: 'endDay',
    Cell: ({...props}) => <DateCell item={props.data[props.row.index].endDay} />,
  },
  {
    Header: (props) => (
